...
socat -v -dddd SCTP-LISTEN:38462,reuseaddr,fork OPENSSL-DTLS-CLIENT:192.168.77.2:2156,cert=${TYPE_PREFIX}/cuupCert.pem,key=${TYPE_PREFIX}/cuupKey.pem,cafile=${TYPE_PREFIX}/root-cert.pem,cipher=$DTLS_CIPHER,openssl-min-proto-version=$DTLS_VERSION &
