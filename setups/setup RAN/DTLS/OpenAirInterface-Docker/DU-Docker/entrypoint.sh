...
socat -v -dd SCTP-LISTEN:38472,reuseaddr,fork OPENSSL-DTLS-CLIENT:192.168.72.2:2155,cert=${TYPE_PREFIX}/duCert.pem,key=${TYPE_PREFIX}/duKey.pem,cafile=${TYPE_PREFIX}/root-cert.pem,cipher=$DTLS_CIPHER,openssl-min-proto-version=$DTLS_VERSION &
