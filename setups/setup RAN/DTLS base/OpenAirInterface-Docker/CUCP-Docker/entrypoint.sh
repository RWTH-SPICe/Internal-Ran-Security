...
socat -v -dd UDP-LISTEN:2155,reuseaddr,fork,reuseport SCTP:192.168.72.2:38472,sourceport=2155 &
socat -v -dd UDP-LISTEN:2156,reuseaddr,fork,reuseport SCTP:192.168.77.2:38462,sourceport=2156 &
