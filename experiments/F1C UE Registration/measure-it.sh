...
DOCKER_COMPOSE_PATH=${DOCKER_COMPOSE_PATH:-$6} #Change this to desired path of the docker compose file! e.g. ../../setups/setup N3/IPsec"
...
# start pcap
docker_compose up -d webui mongodb nrf udr ausf pcf amf bsf upf udm smf oai-cucp oai-cuup oai-du oai-nr-ue
